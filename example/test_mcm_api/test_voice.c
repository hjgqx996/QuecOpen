...
st_api_test_case at_voice_testlist[] = 
{
    ...
    {11,    "QL_Voice_Call_SetAutoAnswer"},
    {12,    "QL_Voice_Call_GetCallStatus"},
    {13,    "QL_Voice_Call_CancelDial"},
...
static int test_voice(void)
{
    ...
    while(1)
    {
        ...
        case 11://"QL_Voice_Call_SetAutoAnswer"
        {
        ...
        case 12://"QL_Voice_Call_GetCallStatus"
        {
            int i;
        ...
        case 13://"QL_Voice_Call_CancelDial"
        {
