...
static int test_sms(void)
{
    ...
    while(1)
    {
        ...
        case 4://"QL_SMS_SetRouteList"
        {
            ...
            printf("please input flag type(1:no storage, 0:default seting)\n");
            scanf("%d", &flags);
            ...
            if (flags)
            {
                for (i = 0; i < E_QL_SMS_MESSAGE_CLASS_MAX; i++)
                {
                    ...
                    t_route_list.route_list[i].route_storage    = E_QL_SMS_STORAGE_TYPE_NONE;
                    t_route_list.route_list[i].receipt_action   = E_QL_SMS_TRANSFER_AND_ACK;
                }
            }
            else
            {
                ...
                {
                    t_route_list.route_list[i].message_class    = i;
                    t_route_list.route_list[i].route_storage    = E_QL_SMS_STORAGE_TYPE_NV;
                    t_route_list.route_list[i].receipt_action   = E_QL_SMS_STORE_AND_NOTIFY;
                }
                t_route_list.route_list[E_QL_SMS_MESSAGE_CLASS_0].receipt_action  = E_QL_SMS_TRANSFER_AND_ACK;        
                t_route_list.route_list[E_QL_SMS_MESSAGE_CLASS_2].route_storage   = E_QL_SMS_STORAGE_TYPE_UIM; 
                t_route_list.route_list[E_QL_SMS_MESSAGE_CLASS_2].receipt_action  = E_QL_SMS_STORE_AND_NOTIFY;        
            }
