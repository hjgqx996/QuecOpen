...
static int test_nw(void)
{
    ...
    while(1)
    {
        ...
        {
            QL_MCM_NW_NITZ_TIME_INFO_T t_info = {0};
        ...
        case 6://"QL_MCM_NW_PerformScan"
        {
            ...
            char *net_status[] = {"NONE", "CURRENT_SERVING", "PREFERRED", "NOT_PREFERRED", "AVAILABLE", "FORBIDDEN"};
        ...
        {
            QL_MCM_NW_SELECTION_INFO_T  t_info = {0};
