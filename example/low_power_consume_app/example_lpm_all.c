...
static int g_ql_lpm_wakeupout_pin = 5;	/* AG35xx default wakeupout(EC20xx is pin 5), in general, user need to cntrol when module is waken by ext_interrupt, sms, voice, or data */
