...
int g_ql_lpm_wakeupout_pin = 5;	/* AG35xx default wakeupout(Ec20xx is pin5), in general, user need to control when module is waken by ext_interrupt, sms, voice, or data */
int ret = 0;
