 ...
 *
 * @Usage 1:
 *      1. cp ql-ol-crosstool/sysroots/armv7a-vfp-neon-oe-linux-gnueabi/usr/include/ql_lib_audio.h ql-ol-extsdk/include/ql_audio.h
 ...
 * @Usage 2:
 *      1.remove include head file ql_oe.h, and add head files like this:
 *          // #include "ql_oe.h"
 *          #include <unistd.h>
 *          #include <stdio.h>
 *          #include <stdint.h>
